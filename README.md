...
4. [General Configurations](/.github/docs/docs-general-configurations.md)
	...
	- 4.5 [Archive Configurations](/.github/docs/docs-general-configurations.md#45---archive-configurations)
		...
		- 4.5.2 [Audio Toneout](/.github/docs/docs-general-configurations.md#452---audio-toneout)
5. [Actions / Integrations](/.github/docs/docs-integrations.md)
	...
	- 5.5 [Audio Generation](/.github/docs/docs-integrations.md#55---audio-generation)
	...
	- 5.7 [Graphic Generation](/.github/docs/docs-integrations.md#57---graphic-generation)
...
7. [Functions](/.github/docs/docs-functions.md)
	...
	- 7.12 [Manual Audio Generation](/.github/docs/docs-functions.md#712---manual-audio-generation)
